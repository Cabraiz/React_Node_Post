  ...
  return (
    <Container fluid className="p-0">
      <Container fluid className="topheader pt-2">
        <Row>
          <Col className="d-flex justify-content-start">
            <Col> 
              <svg class="mt-1 ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g fill="#FFFFFF">
                <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5z"/>
                </g>
              </svg>
              <Form.Label className="ms-auto me-4">(85) 2250.xxxx</Form.Label>
          ...
          <Col className="d-flex justify-content-end">
            <svg height="50%" xmlns="http://www.w3.org/2000/svg" viewBox="0 -75 330 330">
                <g fill="#FFFFFF">
                  <path d="M325.607 79.393c-5.857-5.857-15.355-5.858-21.213 0.001l-139.39 139.393L25.607 79.393 c-5.857-5.857-15.355-5.858-21.213 0.001c-5.858 5.858-5.858 15.355 0 21.213l150.004 150c2.813 2.813 6.628 4.393 10.606 4.393 s7.794-1.581 10.606-4.394l149.996-150C331.465 94.749 331.465 85.251 325.607 79.393z"/>
                </g>
            </svg>
            <Form.Label id="" className="ms-2">MEUS PEDIDOS </Form.Label>
            <svg class="ms-4" height="60%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455 455">
                <g fill="#FFFFFF">
      ...
      <Navbar bg="navbar navbar-custom pt-3 pb-3" variant="dark">
          <Container fluid className="p-0">
              <Row>
                <Container  className="d-flex justify-content-start ms-3">
                <svg class="me-1" style={{ height: 50, width: 80 }} xmlns="http://www.w3.org/2000/svg" viewBox="60 10 70 108">
                <g>
